...
public interface PaymentDomainService {
    ...
    PaymentEvent validateAndInitializePayment(Payment paymentEvent, CreditEntry creditEntry,
            List<CreditHistory> creditHistory, List<String> failureMessages);

    PaymentEvent validateAndCancelledPayment(Payment paymentEvent, CreditEntry creditEntry,
            List<CreditHistory> creditHistory, List<String> failureMessages);
}
