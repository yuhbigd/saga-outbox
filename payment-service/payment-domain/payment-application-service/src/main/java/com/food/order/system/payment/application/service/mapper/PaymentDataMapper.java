...
public class PaymentDataMapper {
    ...
    public OrderEventPayload paymentEventToOrderEventPayload(PaymentEvent payment) {
        return OrderEventPayload.builder()
                ...
                .paymentId(payment.getPayment().getId().getValue().toString())
                .createdAt(payment.getCreatedAt()).failureMessages(payment.getFailureMessages())
                .paymentStatus(payment.getPayment().getStatus().toString()).build();
