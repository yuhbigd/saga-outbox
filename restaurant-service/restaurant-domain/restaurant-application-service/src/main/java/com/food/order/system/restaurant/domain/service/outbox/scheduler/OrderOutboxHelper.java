...
public class OrderOutboxHelper {
    ...
    public Optional<OrderOutboxMessage> getCompletedOrderOutboxMessageBySagaIdAndOutboxStatus(
        ...
        return orderOutboxRepository.findByTypeAndSagaIdAndOutboxStatus(ORDER_PROCESSING_SAGA,
                sagaId, outboxStatus);
    }
    ...
    public void saveOrderOutboxMessage(OrderEventPayload orderEventPayload,
        ...
        save(OrderOutboxMessage.builder().id(UUID.randomUUID()).sagaId(sagaId)
                ...
                .processedAt(ZonedDateTime.now(ZoneId.of(UTC))).type(ORDER_PROCESSING_SAGA)
                .payload(createPayload(orderEventPayload)).approvalStatus(approvalStatus)
