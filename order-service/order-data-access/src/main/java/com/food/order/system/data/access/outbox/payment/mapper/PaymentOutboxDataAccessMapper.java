...
public class PaymentOutboxDataAccessMapper {
    ...
    public PaymentOutboxEntity orderPaymentOutboxMessageToOutboxEntity(
        ...
        return PaymentOutboxEntity.builder().id(orderPaymentOutboxMessage.getId())
                ...
                .version(orderPaymentOutboxMessage.getVersion()).build();
    }

    public OrderPaymentOutboxMessage paymentOutboxEntityToOrderPaymentOutboxMessage(
            PaymentOutboxEntity paymentOutboxEntity) {
        return OrderPaymentOutboxMessage.builder().id(paymentOutboxEntity.getId())
                .sagaId(paymentOutboxEntity.getSagaId())
                .createdAt(paymentOutboxEntity.getCreatedAt()).type(paymentOutboxEntity.getType())
                ...
                .version(paymentOutboxEntity.getVersion()).build();
    }
