...
public class RestaurantDataAccessMapper {
        ...
        public Restaurant restaurantEntityToRestaurant(List<RestaurantEntity> restaurantEntities) {
                var restaurantEntity = restaurantEntities.stream().findFirst().orElseThrow(
                ...
                var restaurantProducts = restaurantEntities.stream()
                                ...
                                .toList();
                var restaurant = Restaurant.builder().products(restaurantProducts)
                                .isActive(restaurantEntity.getRestaurantActive()).build();
