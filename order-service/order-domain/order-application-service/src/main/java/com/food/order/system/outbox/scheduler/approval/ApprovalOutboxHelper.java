...
public class ApprovalOutboxHelper {
    ...
    public Optional<List<OrderApprovalOutboxMessage>> getApprovalOutboxMessageByOutboxStatusAndSagaStatus(
        ...
        return approvalOutboxRepository.findByTypeAndOutboxStatusAndSagaStatus(
                ORDER_PROCESSING_SAGA, outboxStatus, sagaStatus);
    }
    ...
    public Optional<OrderApprovalOutboxMessage> getApprovalOutboxMessageBySagaIdAndSagaStatus(
        ...
        return approvalOutboxRepository.findByTypeAndSagaIdAndSagaStatus(ORDER_PROCESSING_SAGA,
                sagaId, sagaStatus);
    }
    ...
    public void save(OrderApprovalOutboxMessage approvalOutboxMessage) {
        ...
        if (Objects.isNull(response)) {
            throw new OrderDomainException(
                    "Failed to save outbox message id : " + approvalOutboxMessage.getId());
        }
    ...
    public void deleteApprovalOutboxMessageByOutboxStatusAndSagaStatus(OutboxStatus outboxStatus,
        ...
        approvalOutboxRepository.deleteByTypeAndOutboxStatusAndSagaStatus(ORDER_PROCESSING_SAGA,
    ...
    public void saveApprovalOutboxMessage(OrderApprovalEventPayload payload,
        ...
        save(OrderApprovalOutboxMessage.builder().id(UUID.randomUUID()).type(ORDER_PROCESSING_SAGA)
                .createdAt(payload.getCreatedAt()).orderStatus(orderStatus).sagaStatus(sagaStatus)
                .outboxStatus(outboxStatus).sagaId(sagaId).payload(createPayload(payload)).build());
