...
public class PaymentOutboxScheduler implements OutboxScheduler {
        ...
        public void processOutboxMessage() {
                ...
                log.info("Processing payment order outbox message STARTED !");

                var outboxMessageResponse = paymentOutboxHelper
                                .getPaymentOutboxMessageByOutboxMessageStatusAndSagaStatus(
                                                OutboxStatus.STARTED, SagaStatus.STARTED,
                                                SagaStatus.COMPENSATING)
                                .orElseThrow(() -> new OrderDomainException(
                                                "No outbox message found for processing"));
                ...
                if (Objects.nonNull(outboxMessageResponse) && !outboxMessageResponse.isEmpty()) {
                        ...
                        log.info("Received {} OrderPaymentOutboxMessage with ids :  {} , sending message bus !",
                                        ...
                                        outboxMessageResponse.stream().map(
                                                        orderPaymentOutboxMessage -> orderPaymentOutboxMessage
                                                                        .getId().toString())
                                                        .collect(Collectors.joining(",")));
                        outboxMessageResponse.forEach(orderPaymentOutboxMessage -> {
                                paymentRequestMessagePublisher.publish(orderPaymentOutboxMessage,
        ...
        private void updateOutboxStatus(OrderPaymentOutboxMessage orderPaymentOutboxMessage,
                ...
                log.info("Outbox message id : {} updated successfully",
